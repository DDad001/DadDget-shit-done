...
async function createAccount(createdUser){
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/AddUser', {
        method: "POST",
        headers: {
...
async function logIn(userInfo){
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/Login', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function getAllUsers(){
    let res = await fetch("https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/GetAllUsers");
    let data = await res.json();
    // console.log(data);
    return data;
}
...
async function getUserByUsername(Username) {
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/UserByUsername/${Username}`);
    let data = await res.json();
    // console.log(data);
    return data;
}
...
{
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/UpdateUser/${userData.Username}`, {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
{
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/DeleteUser/${userData.Username}`, {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function updateUserRole(UserName, IsAdmin, isProjectManager, isSpecialist) {
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/User/UpdateUserRole/'+UserName+'/'+IsAdmin+'/'+isProjectManager+'/'+isSpecialist, {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function AddProjectItem(NewProject) {
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/AddProjectItem', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function getAllProjectItems(){
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetAllProjectItems');
    let data = await res.json();
    return data;
}
...
async function getProjectItemById(Id){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemById/${Id}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemsByUserId(UserId){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemsByUserId/${UserId}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemByTitle(Title){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemByTitle/${Title}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemByDescription(Description){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemByDescription/${Description}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemByDateCreated(DateCreated){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemByDateCreated/${DateCreated}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemByDueDate(DueDate){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemByDueDate/${DueDate}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemsByStatus(Status){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemsByStatus/${Status}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemsByAMemberId(MemberId){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemsByAMemberId/${MemberId}`);
    let data = await res.json();
    return data;
}
...
async function getProjectItemsByAMemberUsername(MemberUsername){
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetProjectItemsByAMemberUsername/${MemberUsername}`);
    let data = await res.json();
    return data;
}
...
async function getDeletedProjectItems(){
    ...
    let res = await fetch("https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetDeletedProjectItems");
    let data = await res.json();
    return data;
}
 ...
 async function getArchivedProjectItems(){
    ...
    let res = await fetch("https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/GetArchivedProjectItems");
    let data = await res.json();
    return data;
}
...
async function updateProjectItem(UpdatedProject) {
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/UpdateProjectItem', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function deleteProjectItem(DeletedProject) {
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/ProjectItem/DeleteProjectItem', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function AddTaskItem(NewTaskItem) {
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/AddTaskItem', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function getAllTaskItems(){
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetAllTaskItems');
    let data = await res.json();
    return data;
}
...
async function getTaskItemsById(ID) {
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsById/${ID}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemsByProjectID(ProjectID) {
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsByProjectID/${ProjectID}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemByTitle(Title) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemByTitle/${Title}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemByDescription(Description) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemByDescription/${Description}`);
    let data = await res.json();
    console.log(data);
    return data;
...
async function getTaskItemsByDateCreated(DateCreated) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsByDateCreated/${DateCreated}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemsByDueDate(DueDate) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsByDueDate/${DueDate}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemsByPrority(Priority) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsByPriority/${Priority}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemsByAssignee(Assignee) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsByAssignee/${Assignee}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function getTaskItemsByStatus(Status) {
    ...
    let res = await fetch(`https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/GetTaskItemsByStatus/${Status}`);
    let data = await res.json();
    console.log(data);
    return data;
}
...
async function updateTaskItem(TaskUpdate) {
    ...
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/UpdateTaskItem', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
...
async function deleteTaskItem(TaskDelete) {
    let res = await fetch('https://daddgetstuffdoneprojectbackend.azurewebsites.net/TaskItem/DeleteTaskItem', {
        method: "POST",
        headers: {
            'Content-Type': "application/json"
        },
